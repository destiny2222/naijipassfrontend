  ...
  return (
    <div className="p-4 sm:p-8 max-w-[1600px] mx-auto w-full">
      ...
      {user?.kyc && user.kyc.status !== 'approved' && (
        <div className={`mb-8 rounded-[18px] border p-5 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4 ${user.kyc.status === 'rejected' ? 'border-red-100 bg-red-50/50' : 'border-amber-100 bg-amber-50/50'
          }`}>
      ...
      {isBusiness ? (
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
          {metrics.map((metric) => (
            <div
              key={metric.label}
              className={`rounded-[18px] border border-zinc-100 bg-white p-5 shadow-sm transition-all hover:shadow-md ${metric.accent}`}
            >
              ...
              <span className="mt-1 block text-[10px] font-bold text-mod-primary">
                {metric.change}
              </span>
            </div>
          ))}
        ...
        <div className="space-y-8 mb-8">
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
            <div className="rounded-[18px] border border-zinc-100 bg-white p-6 shadow-sm transition-all hover:shadow-md relative">
              <div className="absolute top-6 right-6 text-mod-primary bg-orange-50 p-2 rounded-xl">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
              </div>
              <h3 className="text-sm font-bold text-slate-800">Active Bids</h3>
              <p className="mt-4 text-4xl font-black text-slate-800">{activities.length}</p>
            ...
            <div className="rounded-[18px] border border-zinc-100 bg-white p-6 shadow-sm transition-all hover:shadow-md relative">
              ...
              <h3 className="text-sm font-bold text-slate-800">Registered Businesses</h3>
              <p className="mt-4 text-4xl font-black text-slate-800">{verifiedBusinesses.length}</p>
              <div className="mt-3 flex items-center gap-1.5 text-[11px] font-bold text-zinc-500">
            ...
            <div className="rounded-[18px] bg-gradient-to-br from-mod-primary to-blue-600 p-6 shadow-lg relative overflow-hidden flex flex-col justify-between">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2.5 mb-3">
                  <div className="bg-mod-primary p-1.5 rounded-lg text-white shadow-md shadow-[#FF6B2B]/20">
              ...
              <button className="relative z-10 mt-5 w-full rounded-xl bg-mod-primary py-2.5 text-xs font-bold text-white shadow-lg shadow-[#FF6B2B]/20 hover:bg-[#E55F23] transition-all hover:scale-[1.02] flex items-center justify-center gap-2">
                Chat Now
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
              <div className="rounded-[18px] border border-zinc-100 bg-white p-6 shadow-sm transition-all hover:shadow-md hover:border-mod-primary/30 cursor-pointer group">
                <div className="w-10 h-10 rounded-xl bg-zinc-50 border border-zinc-100 flex items-center justify-center text-zinc-500 mb-4 group-hover:text-mod-primary group-hover:bg-orange-50 group-hover:border-orange-100 transition-colors">
              ...
              <div className="rounded-[18px] border border-zinc-100 bg-white p-6 shadow-sm transition-all hover:shadow-md hover:border-mod-primary/30 cursor-pointer group">
                ...
                <h3 className="text-sm font-bold text-slate-800 mb-1">Submit Bid</h3>
              ...
              <div className="rounded-[18px] border border-zinc-100 bg-white p-6 shadow-sm transition-all hover:shadow-md hover:border-mod-primary/30 cursor-pointer group">
                ...
                <h3 className="text-sm font-bold text-slate-800 mb-1">Search Laws</h3>
      ...
      {isBusiness && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          {/* Bids by Category */}
          <div className="rounded-[18px] border border-zinc-100 bg-white p-6 shadow-sm">
            <div className="mb-6">
              <h3 className="text-base font-bold text-slate-800">Bids by Category</h3>
          ...
          <div className="rounded-[18px] border border-zinc-100 bg-white p-6 shadow-sm">
            <div className="mb-6">
              <h3 className="text-base font-bold text-slate-800">Businesses by Industry</h3>
          ...
          <div className="rounded-[18px] border border-zinc-100 bg-white p-6 shadow-sm">
            <div className="mb-6">
              <h3 className="text-base font-bold text-slate-800">Contracts Overview</h3>
          ...
          <div className="rounded-[18px] border border-zinc-100 bg-white p-6 shadow-sm">
            <div className="mb-6">
              <h3 className="text-base font-bold text-slate-800">Verification Status</h3>
      ...
      <div className="mb-8">
        <div className="mb-4">
          <h2 className="text-lg font-black text-slate-800">Verified Businesses Directory</h2>
        ...
        {verifiedBusinesses.length > 0 ? (
          <div className="flex gap-5 overflow-x-auto pb-6 pt-2 snap-x px-1 scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            {verifiedBusinesses.map((biz) => (
              <div key={biz.id} className="min-w-[280px] max-w-[280px] sm:min-w-[320px] sm:max-w-[320px] snap-start shrink-0 rounded-[18px] border border-zinc-100 bg-white p-6 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                ...
                <div className="flex items-center gap-3 mb-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-zinc-50 border border-zinc-100 text-slate-800 font-black text-lg">
                    {biz.businessName?.charAt(0) || "B"}
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-slate-800 line-clamp-1">{biz.businessName}</h4>
                ...
                <div className="mt-5 pt-4 border-t border-zinc-50 flex items-center justify-between">
                  ...
                  <button className="text-xs font-bold text-mod-primary group-hover:text-[#E55F23] flex items-center gap-1 transition-colors">
                    View Profile
          ...
          <div className="rounded-[18px] border border-zinc-100 bg-white p-8 text-center shadow-sm">
        ...
        <div className="space-y-8">
          ...
          {/* <div className="rounded-[18px] border border-zinc-100 bg-white p-6 shadow-sm">
                ...
                <div className="mt-5 space-y-3">
                  <button className="flex w-full h-11 items-center justify-center gap-2 rounded-xl bg-mod-primary text-xs font-bold text-white shadow-md shadow-[#FF6B2B]/10 hover:bg-[#E55F23] hover:-translate-y-0.5 transition-all">
