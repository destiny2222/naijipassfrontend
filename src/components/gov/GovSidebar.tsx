...
export default function GovSidebar({ activeItem, isOpen, onClose }: GovSidebarProps) {
  ...
  return (
    <>
      ...
      <nav className="flex-1 space-y-1.5 px-4 py-6">
        <div className="mb-4 px-4 text-xs font-bold text-slate-400 uppercase tracking-wider">State Management</div>
        {menuItems.map((item) => {
